...
<style scoped>
.text-rainbow {
    background-image: linear-gradient(to left, rgb(240, 130, 240), rgb(190, 112, 245), rgb(0, 195, 255), rgb(0, 255, 0), rgb(255, 255, 0), rgb(255, 165, 0), rgb(255, 79, 79));
...
<template>
    <span class="cursor-pointer text-rainbow sm:py-2 py-[0.6px] sm:px-3 rounded-md font-bold" @click="showPopup = true">{{
        popupTitle }}</span>
    <PopupModal v-if="showPopup" @close="closePopup">
        <template v-slot:body>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <MyButton @clickedd="reactToAll" :loading="loading">Upload Realmojis</MyButton>
                </div>
            </div>
        </template>
    </PopupModal>
